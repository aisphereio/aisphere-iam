...
Legacy Organization CRUD has been removed by PR #40 (`0425275`). Project scope and owner now derive from the authenticated Kernel Principal via `currentProjectContext`.
